...
function PerkItem({ name, label, icon, selected, onChange }) {
    return (
        <label className='border p-4 flex rounded-2xl gap-2 items-center cursor-pointer'>
            <input type='checkbox' checked={selected.includes(name)} name={name} onChange={onChange} />
            {icon}
            <span>{label}</span>
        </label>
    );
